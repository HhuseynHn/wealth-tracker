...
const saveSubscription = (state, userId) => {
    if (!userId)
        return;
    try {
...
const subscriptionSlice = createSlice({
    ...
    reducers: {
        ...
        loadUserSubscription: (state, action) => {
...
export const { loadUserSubscription, upgradePlan, startTrial, cancelSubscription, checkSubscriptionStatus, renewSubscription, } = subscriptionSlice.actions;
export default subscriptionSlice.reducer;
// Selectors
export const selectIsProUser = (state) => state.subscription.currentPlan !== 'free';
export const selectCanUseFeature = (state, feature) => state.subscription.features[feature];
