...
export const { addGoal, updateGoal, deleteGoal, addContribution, selectGoal, setLoading, setError, } = goalSlice.actions;
export default goalSlice.reducer;
// Selectors
export const selectAllGoals = (state) => state.goals.goals;
export const selectActiveGoals = (state) => state.goals.goals.filter((g) => g.currentAmount < g.targetAmount);
export const selectCompletedGoals = (state) => state.goals.goals.filter((g) => g.currentAmount >= g.targetAmount);
export const selectGoalById = (state, id) => state.goals.goals.find((g) => g.id === id);
export const selectGoalsStats = (state) => {
